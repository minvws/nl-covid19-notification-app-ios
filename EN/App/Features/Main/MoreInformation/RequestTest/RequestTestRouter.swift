...
protocol RequestTestViewControllable: ViewControllable {
    var router: RequestTestRouting? { get set }
...
final class RequestTestRouter: Router<RequestTestViewControllable>, RequestTestRouting {
    
    // MARK: - Initialisation
    
    init(listener: RequestTestListener,
         viewController: RequestTestViewControllable /*,
