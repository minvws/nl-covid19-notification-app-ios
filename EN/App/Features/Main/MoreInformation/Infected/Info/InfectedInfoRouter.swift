...
/// @mockable
protocol InfectedInfoViewControllable: ViewControllable {
    var router: InfectedInfoRouting? { get set }
...
final class InfectedInfoRouter: Router<InfectedInfoViewControllable>, InfectedInfoRouting {
    
    // MARK: - Initialisation
    
    init(listener: InfectedInfoListener,
         viewController: InfectedInfoViewControllable /*,
    ...
    private weak var listener: InfectedInfoListener?
