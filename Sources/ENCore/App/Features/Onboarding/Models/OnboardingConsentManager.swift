    ...
    init(exposureStateStream: ExposureStateStreaming,
        ...
        onboardingConsentSteps.append(
            OnboardingConsentStep(
                ...
                illustration: theme.lottieSupported ? .animation(named: "permission", repeatFromFrame: 100, defaultFrame: 56) : .image(image: Image.named("Step6")),
        ...
        onboardingConsentSteps.append(
            OnboardingConsentStep(
                ...
                illustration: theme.lottieSupported ? .animation(named: "share", repeatFromFrame: 31, defaultFrame: 35) : .image(image: Image.named("Step7")),
