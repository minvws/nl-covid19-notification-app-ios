...
final class OnboardingViewControllerTests: TestCase {
    ...
    func test_displayExposureNotificationSettings_shouldCallRouter() {
        // Arrange
        XCTAssertEqual(mockOnboardingRouter.routeToExposureNotificationSettingsCallCount, 0)

        // Act
        sut.displayExposureNotificationSettings()

        // Assert
        XCTAssertEqual(mockOnboardingRouter.routeToExposureNotificationSettingsCallCount, 1)
    }
}
