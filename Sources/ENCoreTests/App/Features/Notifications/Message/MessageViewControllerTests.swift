...
final class MessageViewControllerTests: TestCase {
    ...
    func testSnapshotMessageViewController_withListAndText() {
        ...
        viewController = MessageViewController(listener: listener, theme: theme, interfaceOrientationStream: mockInterfaceOrientationStream, dataController: dataController, messageManager: messageManager, applicationController: mockApplicationController)
    ...
    private lazy var fakeMessageWithListOnly: LocalizedTreatmentPerspective = {
        LocalizedTreatmentPerspective(paragraphs: [
            .init(title: "Paragraph Title",
                  body: NSAttributedString.htmlWithBulletList(text: "<ul><li>List Item 1</li><li>List Item 2</li></ul>", font: self.theme.fonts.body, textColor: self.theme.colors.textSecondary, theme: self.theme, textAlignment: .left),
                  type: .paragraph),
    ...
    private lazy var fakeMessageWithoutList: LocalizedTreatmentPerspective = {
        LocalizedTreatmentPerspective(paragraphs: [
            .init(title: "Paragraph Title",
                  body: NSAttributedString.htmlWithBulletList(text: "Some paragraph of text that is not followed by a list\\n\\nSome other paragraph of text", font: self.theme.fonts.body, textColor: self.theme.colors.textSecondary, theme: self.theme, textAlignment: .left),
                  type: .paragraph),
            .init(title: "Paragraph Title",
                  body: NSAttributedString.htmlWithBulletList(text: "Some paragraph of text that is not followed by a list\\n\\nSome other paragraph of text", font: self.theme.fonts.body, textColor: self.theme.colors.textSecondary, theme: self.theme, textAlignment: .left),
                  type: .paragraph)
