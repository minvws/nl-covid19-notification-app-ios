...
final class NetworkManagerTests: TestCase {
    ...
    func test_getAppConfig_requestSuccessShouldReturnModel() throws {
        ...
        let mockModel = AppConfig(version: 1, manifestFrequency: 10, decoyProbability: 2, appStoreURL: "someurl", iOSMinimumVersion: "1.0.0", iOSMinimumVersionMessage: "", iOSAppStoreURL: "", requestMinimumSize: 10, requestMaximumSize: 20, repeatedUploadDelay: nil, coronaMelderDeactivated: nil, coronaMelderDeactivatedTitle: nil, coronaMelderDeactivatedBody: nil, appointmentPhoneNumber: nil, featureFlags: [], notification: nil, shareKeyURL: "http://www.coronatest.nl", coronaTestURL: "https://coronatest.nl/ik-wil-me-laten-testen/online-een-afspraak-maken")
